...
This is a LocalStack UI project - a web interface for managing LocalStack (local AWS cloud stack emulator). The repository is currently empty and ready for initial development.

## Development Setup

This project is in initial setup phase. Common commands will be documented here as the project develops.
